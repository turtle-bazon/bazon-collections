...
(defun test-list (list-class
  ...
  (let ((list (funcall constructor-function)))
    ...
    #+nil(ensure-same 2 (index-of list (funcall element-function 8))
    ...
    (insert-objects-before list 6 (mapcar element-function '(1 2)))
    ...
    (ensure-same 2 (funcall de-e (get-object-at list 7))
		 :report (report-name list-class "2 is at 1 after insert b a"))
    ))
