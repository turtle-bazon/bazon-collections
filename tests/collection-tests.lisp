...
(defun test-collection (collection-class constructor-function element-function
			de-e equal-function oddpf evenpf)
  (flet ((equalf (o1 o2)
	   (funcall equal-function o1 o2)))
    (let ((collection (funcall constructor-function)))
      ...
      (ensure-same (funcall element-function 0)
		   (it-current (find-object collection (funcall element-function 0)))
		   :test equalf
      ...
      (ensure-same (funcall element-function 1)
		   (it-current (find-object collection (funcall element-function 1)))
		   :test equalf
