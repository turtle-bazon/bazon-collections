...
(defun test-list-insert-before-iterator-state (list-class constructor-function element-function de-e)
  (let ((list (funcall constructor-function)))
    ...
    (let ((iterator (iterator list)))
      ...
      (it-next iterator)
      (it-next iterator)
      (insert-object-before list iterator (funcall element-function 4))
      (ensure-same 2 (funcall de-e (it-current iterator))
		   :report (report-name list-class "2 is at position of iterator after insert before")))))

(defun test-list-insert-all-before-iterator-state (list-class constructor-function element-function de-e)
  (let ((list (funcall constructor-function )))
    (add-all-objects list (mapcar element-function '(1 2 3)))
    (let ((iterator (iterator list)))
      (it-before-first iterator)
      (it-next iterator)
      (it-next iterator)
      (insert-all-objects-before list iterator (mapcar element-function '(4 5)))
      (ensure-same 2 (funcall de-e (it-current iterator))
		   :report (report-name list-class "2 is at position of iterator after insert all before")))))

(defun test-list-insert-after-iterator-state (list-class constructor-function element-function de-e)
  (let ((list (funcall constructor-function)))
    (add-all-objects list (mapcar element-function '(1 2 3)))
    (let ((iterator (iterator list)))
      (it-before-first iterator)
      (it-next iterator)
      (it-next iterator)
      (insert-object-after list iterator (funcall element-function 4))
      (ensure-same 2 (funcall de-e (it-current iterator))
		   :report (report-name list-class "2 is at position of iterator after insert after")))))

(defun test-list-insert-all-after-iterator-state (list-class constructor-function element-function de-e)
  (let ((list (funcall constructor-function )))
    (add-all-objects list (mapcar element-function '(1 2 3)))
    (let ((iterator (iterator list)))
      (it-before-first iterator)
      (it-next iterator)
      (it-next iterator)
      (insert-all-objects-after list iterator (mapcar element-function '(4 5)))
      (ensure-same 2 (funcall de-e (it-current iterator))
		   :report (report-name list-class "2 is at position of iterator after insert all after")))))
...
(defun test-list (list-class
  ...
  (let ((list (funcall constructor-function)))
    ...
    (test-list-insert-before-iterator-state list-class constructor-function element-function de-e)
    (test-list-insert-all-before-iterator-state list-class constructor-function element-function de-e)
    (test-list-insert-after-iterator-state list-class constructor-function element-function de-e)
    (test-list-insert-all-after-iterator-state list-class constructor-function element-function de-e)
    ))
